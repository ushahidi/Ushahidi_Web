 ...
 */
class Wax_Controller extends Template_Controller {
	/**
	...
	public function __construct()
	{
        ...
        // Load Header & Footer
		$this->template->header  = new View('wax/header');
    ...
    public function index()
    {
        ...
        $this->template->content = new View('wax/main');

		// Cacheable Main Controller
		$this->is_cachable = TRUE;

		// Map and Slider Blocks
		$div_map = new View('wax/main_map');
		$div_timeline = new View('wax/main_timeline');
