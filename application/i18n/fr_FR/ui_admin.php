...
(
    ...
    'stats' => 'Stats',
    'stats_collection_error' => 'Erreur de récuperation des statistiques! Soit la «stat_id» ou la «stat_key» dans la table «settings» de votre base de données sont éronnées, soit le serveur de statistique est indisponible. Réessayez plus tard, au cas ou le serveur redeviendrait disponible. Sinon, vous pouvez essayer de modifier stat_id (mettre à «null») et stat_key (mettre à 0) dans la table settings de votre base de données pour réinitialiser vos statistiques. Toutefois vous perdrez l\'accès au statistiques courantes, sur le serveur.',
