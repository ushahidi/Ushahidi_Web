	...
	<div class="big-block-bottom">
	  ...
	  <div class="green-box">
	    ...
	    <?php 
               ...
               {
               ?>
            <div class="alert_response">Your [MOBILE] Alert request has been created and a
              ...
              <div class="alert_confirm">
                <div class="label">Please enter the SMS confirmation [CODE] you received on your mobile phone below:</div>
                <?php 
                   print form::open();
                   print form::input('alert_code', '');
                   print "&nbsp;&nbsp;";
                   print form::button('button', 'Confirm My Mobile Number');
                   print form::close();
                   }
                   ?>
                  </div>
            ...
            <div class="alert_response">Your [EMAIL] Alert request has been
              ...
              the verification email and confirm your request.</div>  
            <?php 
               }
               ?>
               <div class="alert_response"><a href="<?php echo
