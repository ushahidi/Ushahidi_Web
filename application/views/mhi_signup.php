...
?>
	...
	<?php print form::open(url::base().'mhi/create', array('id' => 'frm-MHI-Signup', 'name' => 'frm-MHI-Signup', 'class' => 'frm-content')); ?>
		...
		<img src="media/img/mhi/step-1.gif" align="left" class="step" /> <h2 class="step-1">Verify Your Account</h2>

		<table><tbody>
			<tr>
				<td><label for="verify_password">Account Password</label></td>
				<td><input type="password" size="24" name="verify_password" maxlength="42" id="verify_password"/></td>
			</tr>
		</tbody></table>
