			...
			<div class="bg">
				...
				<div class="report-form">
					...
					<div class="sms_nav_holder">
						<a href="<?php echo url::site() . 'admin/settings/sms' ?>"><?php echo Kohana::lang('settings.sms.option_1');?></a>
						<a href="<?php echo url::site() . 'admin/settings/smsglobal' ?>" class="active"><?php echo Kohana::lang('settings.sms.option_2');?></a>
					</div>
