            ...
            <div class="bg">
            	...
            	<div class="tabs">
                    ...
                    <ul class="tabset">
                        ...
                        <li><a href="<?php echo url::site() ?>admin/manage/api/log" <?php if ($this_page == 'apilogs') echo "class=\"active\""?>><?php echo Kohana::lang('ui_admin.api_logs');?></a></li>
                        <li><a href="<?php echo url::site() ?>admin/manage/api/apibanned"><?php echo Kohana::lang('ui_admin.api_banned'); ?></a></li>
                    </ul>
                    <!-- /tabset -->
