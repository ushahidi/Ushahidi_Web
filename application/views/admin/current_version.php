...
<?php if ((Kohana::config('config.enable_auto_upgrader') == TRUE)) {?>
    ...
    <?php if ( Kohana::config('config.enable_ver_sync_warning') == TRUE && ( url::current() != "admin/upgrade") && (Kohana::config('version.ushahidi_version') != Kohana::config('settings.ushahidi_version'))) { ?>
        <div id="update-info">
    ...
    <?php if (( url::current() != "admin/upgrade") && (Kohana::config('version.ushahidi_db_version') != Kohana::config('settings.db_version'))) { ?>
        <div id="update-info">
