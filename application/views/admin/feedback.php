					...
					?>
						...
						foreach ( $all_feedback as $feedback )
						{
							...
							<tr>
								...
								<td class="col-2">
									<div class="post">
										<h4><a href="<?php echo url::base() . 'admin/feedback/edit/' . $feedback_id; ?>" class="more"><?php echo $feedback_title; ?></a></h4>
										<p><?php echo $feedback_mesg; ?>... <a href="<?php echo url::base() . 'admin/feedback/edit/' . $feedback_id; ?>" class="more">more</a></p>
									</div>
									<ul class="info">
