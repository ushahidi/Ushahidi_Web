			<div class="bg">
				<h2><?php echo $title; ?> <span>(<?php echo $total_items; ?>)</span><a href="<?php print url::base() ?>admin/reports/edit">Create New Report</a><a href="<?php print url::base() ?>admin/reports/download">Download Reports</a></h2>
				<!-- tabs -->
				<div class="tabs">
					<!-- tabset -->
					<ul class="tabset">
