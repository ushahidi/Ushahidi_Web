	...
	<div id="time-period-selector">
		<p>
			<form method="get" action="<?php print url::base() ?>admin/stats/country/" style="display: inline;">
				<?php echo Kohana::lang('stats.choose_date_range');?>: <a href="<?php print url::base() ?>admin/stats/country/?range=30"><?php echo Kohana::lang('stats.time_range_1');?></a> <a href="<?php print url::base() ?>admin/stats/country/?range=90"><?php echo Kohana::lang('stats.time_range_2');?></a> <a href="<?php print url::base() ?>admin/stats/country/?range=180"><?php echo Kohana::lang('stats.time_range_3');?></a>  <a href="<?php print url::base() ?>admin/stats/country/"><?php echo Kohana::lang('stats.time_range_all');?></a>
