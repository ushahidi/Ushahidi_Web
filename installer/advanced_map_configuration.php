...
<title>Map Configuration / Ushahidi Web Installer</title>
		...
		<li class="last"><span>Finished</span></li>
        	...
        	<form method="POST" name="frm_install" action="process.php" style="line-height: 100%; margin-top: 0; margin-bottom: 0;">  
                ...
                <table class="form-table">
                	<tbody>
                    	<tr>
                        	<td class="next"><a class="button" href="advanced-mail-server-settings.html">&larr; Previous</a><!--<input type="button" class="button" value="&larr; Previous" />--></td>
                            <td class="prev"><a class="button" href="advanced-finished.html">Continue &rarr;</a><!--<input type="button" class="button" value="Continue &rarr;" />--></td>
                        </tr>
                	</tbody>
                </table>
        	</form>
