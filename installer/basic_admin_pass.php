<?php
	...
	if(!isset( $_SESSION['basic_admin_pass']) && $_SESSION['basic_admin_pass'] != 'basic_general_settings'){
	...
	<div id="ushahidi_login">
		...
		<form method="POST" name="frm_install" action="process.php" style="line-height: 100%; margin-top: 0; margin-bottom: 0;">  
			...
			<table class="form-table">
				<tbody>
					<tr>
						<td class="next"><a class="button" href="basic_general_settings.php">&larr; Previous</a></td>
						<td class="prev"><input type="submit" id="basic_admin_pass" name="basic_admin_pass" value="Continue &rarr;" class="button" /></td>
					</tr>
				</tbody>
			</table>
		</form>
