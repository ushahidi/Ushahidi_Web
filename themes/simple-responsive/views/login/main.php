...
<div id="openid_login_container" class="container">
	...
	<?php if ($form_error): ?>
		<div class="login_error ui-corner-all col-xs-12">
	...
	<div id="password_reset_change_form" class="ui-corner-all col-xs-12">
	...
	<div id="openid_login" class="ui-corner-all col-xs-12">
