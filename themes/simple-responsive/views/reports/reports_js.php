...
?>
	 ...
	 */
	 function switchViews(view)
	 {
		...
		$("#reports-box-block .report-list-toggle a").parent().removeClass("active");
	...
	{
		$("#reports-box-block .report-list-toggle a").click(function(){
...
<?php } ?>
	...
	function fetchReports()
	{
		...
		$("#reports-box-block").html(statusHtml);
			...
			function(data) {
				if (data != null && data != "" && data.length > 0) {
					...
					setTimeout(function(){
						...
						{
							switchViews($("#reports-box-block .report-list-toggle a.map"));
						}
