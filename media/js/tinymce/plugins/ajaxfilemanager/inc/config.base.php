...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../../uploads/images/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../../uploads/images');	//accept relative path only
	...
	define('CONFIG_UPLOAD_MAXSIZE', 10485760); //by bytes
